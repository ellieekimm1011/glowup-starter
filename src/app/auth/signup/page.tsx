...
// The registration page where new users create their account.
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      const { error } = await supabase.auth.signUp({
        ...
        password,
        options: {
          // This data goes into the user's metadata
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-nude-600 text-sm">
            Start your personalized makeup journey
          </p>
        </div>
        ...
        <p className="text-center text-nude-600 text-sm mt-6">
          ...
          <Link href="/auth/login" className="text-blush-600 hover:text-blush-700 font-medium">
            Sign in
          </Link>
        </p>
      </div>
